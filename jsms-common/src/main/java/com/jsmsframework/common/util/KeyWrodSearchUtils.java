...
public class KeyWrodSearchUtils {
     ...
     * @param params
     * @param key 正常内容key
     * @param simpleChinesesKey 简体字key
     * @param traditionalChineseKey 繁体字key
     * @return
     */
    public static Map<String,String> specialNumericDeal(Map<String,String> params,String key,String simpleChinesesKey,String traditionalChineseKey){
        if(params!=null){
            String condition = (String) params.get(key);
            String simplifredChineseCondition = (String) params.get(simpleChinesesKey);
            String traditionalChineseCondition = (String) params.get(traditionalChineseKey);
            if(StringUtils.isNotBlank(condition)){
                condition = condition.replaceAll("\\\\","\\\\\\\\");
                condition = condition.replaceAll("_","\\\\_");
                condition = condition.replaceAll("%","\\\\%");
                condition = condition.replaceAll("'","\\\\'");
                params.put(key,condition);
            }
            if(StringUtils.isNotBlank(simplifredChineseCondition)){
                ...
                simplifredChineseCondition = simplifredChineseCondition.replaceAll("%","\\\\%");
                simplifredChineseCondition = simplifredChineseCondition.replaceAll("'","\\\\'");
                params.put(simpleChinesesKey,simplifredChineseCondition);
            }
            if(StringUtils.isNotBlank(traditionalChineseCondition)){
                ...
                traditionalChineseCondition = traditionalChineseCondition.replaceAll("%","\\\\%");
                traditionalChineseCondition = traditionalChineseCondition.replaceAll("'","\\\\'");
                params.put(traditionalChineseKey,traditionalChineseCondition);
            }
        }
        return params;
    }
