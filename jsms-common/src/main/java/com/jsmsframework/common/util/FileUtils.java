...
public class FileUtils extends org.apache.commons.io.FileUtils{
	private static final Logger logger = LoggerFactory.getLogger(com.ucpaas.sms.common.util.file.FileUtils.class);
	...
	public static boolean copyFile(String srcFileName, String descFileName) {
		return com.ucpaas.sms.common.util.file.FileUtils.copyFileCover(srcFileName, descFileName, false);
	}
	...
	public static boolean copyFileCover(String srcFileName, String descFileName, boolean coverlay) {
		...
		if (descFile.exists()) {
			...
			if (coverlay) {
				...
				if (!com.ucpaas.sms.common.util.file.FileUtils.delFile(descFileName)) {
	...
	public static boolean copyDirectory(String srcDirName, String descDirName) {
		return com.ucpaas.sms.common.util.file.FileUtils.copyDirectoryCover(srcDirName, descDirName, false);
	}
	...
	public static boolean copyDirectoryCover(String srcDirName, String descDirName, boolean coverlay) {
		...
		if (descDir.exists()) {
			if (coverlay) {
				...
				if (!com.ucpaas.sms.common.util.file.FileUtils.delFile(descDirNames)) {
		...
		for (int i = 0; i < files.length; i++) {
			// 如果是一个单个文件，则直接复制
			if (files[i].isFile()) {
				flag = com.ucpaas.sms.common.util.file.FileUtils.copyFile(files[i].getAbsolutePath(), descDirName + files[i].getName());
				// 如果拷贝文件失败，则退出循环
				if (!flag) {
					break;
				}
			...
			if (files[i].isDirectory()) {
				flag = com.ucpaas.sms.common.util.file.FileUtils.copyDirectory(files[i].getAbsolutePath(), descDirName + files[i].getName());
				// 如果拷贝目录失败，则退出循环
				if (!flag) {
					break;
				}
