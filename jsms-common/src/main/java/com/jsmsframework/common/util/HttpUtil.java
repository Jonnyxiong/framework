...
public class HttpUtil {
	...
	public static String httpPost(String url, String content, boolean needSSL) {
		return HttpUtil.httpPost(url, content, needSSL,ContentType.APPLICATION_JSON);
	}
	public static String httpFormPost(String url, String content, boolean needSSL) {
		return HttpUtil.httpPost(url, content, needSSL,ContentType.APPLICATION_FORM_URLENCODED);
	}
