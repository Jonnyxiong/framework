...
public class JsmsChannel {
    ...
    // 是否支持群发短信，0：不支持，1：支持多号码单内容，2：支持多号码多内容
    private Integer clusterType;
    // 群发组包支持最大条数
    private Integer clusterMaxNumber;
    // 群发组包时最长等待时间，单位：毫秒
    private Integer clusterMaxTime;
    // 协议子类型，0：全网，1：cmpp福建省网
    private Integer protocolType;
    // 调用库名，适用于httpmode=1、2时
    private String libName;
    // 扩展属性，1：中文，2：英文，4：缓存状态报告到MQ队列
    ...
    public Integer getClusterMaxTime() {
        return clusterMaxTime;
    }
    
    public void setClusterMaxTime(Integer clusterMaxTime) {
        this.clusterMaxTime = clusterMaxTime ;
    }
